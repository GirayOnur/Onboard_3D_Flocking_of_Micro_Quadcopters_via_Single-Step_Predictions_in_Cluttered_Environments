...
line([0.75,3.25],[0.5,0.5],'Color','red','LineStyle','--', 'LineWidth', 1.5)

line([0.75,3.25],[0.45,0.45],'Color','black','LineStyle','--', 'LineWidth', 1.5)
...
%}
set(gca,'fontsize', 22);
ylabel('min\boldmath$(m_{o})\,[m]$','Interpreter','latex','fontsize', 30)
