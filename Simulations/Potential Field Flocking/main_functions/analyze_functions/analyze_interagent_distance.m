%plots the normalized inter-robot distance:
function [done,arrEd,arrMin]=analyze_interagent_distance(dt,posData,refDist,simStep,agentNum,quadRad,senseRange,Mmax) %(dt,sim_pos_list,???,double(sim_kk),quadNum,quad_rad,sense_range)
    ign_kk = int16(0.5/dt);
    ...
    plot(arrTime,arrEd, 'Color', [0 0.4470 0.7410], 'LineWidth', 1.2)
    hold on
