%main function for the Potential Field flocking method that calculates velocity inputs of the robots
%Ref: Soria, Nature Machine Intelligence, 2020
%Copyright 2020 Enrica Soria
%modified for arranging the input-output relationship with the
%simulator

function [vel_command] = compute_vel_vasarhelyi(p_swarm, r_agent, dt, pos_sim, vel_sim, quad_num)
